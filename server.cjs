 ...
 * This shim exists because `npm run server` and the Vercel wrapper
 * (api/index.js) point at server.cjs. The Dockerfile and the Electron shell
 * that also used it were removed.
 */
