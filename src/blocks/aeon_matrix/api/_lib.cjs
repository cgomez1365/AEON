...
// Extraction moved to the kernel (src/kernel/extract.cjs) so /read can use it
// too; these names are kept for the two callers in this block.
const { loadExtractors, extractText, htmlToText } = require('../../../kernel/extract.cjs');
